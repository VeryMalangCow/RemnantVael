...
[CustomEditor(typeof(AllyResoSO))]
public class AllyResoSOEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        AllyResoSO iconSO = (AllyResoSO)target;
    ...
    private void CollectAllyCardSprites(AllyResoSO iconSO)
    {
