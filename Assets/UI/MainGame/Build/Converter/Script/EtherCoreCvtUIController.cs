...
public class EtherCoreCvtUIController : ConverterUIController
{
    ...
    private CvtMaterialEUIController protoCvtMaterialEui;
    private static int need_ChargedBettery = 10;
    private static int need_Credit = 50;
    private static int need_ProtoC = 3;
    ...
    public override IEnumerator InitAsync(Color mainClr, Color subClr)
    {
        ...
        protoCvtMaterialEui = cvtMaterialEuis[2];
    ...
    protected override void Set_MaxAcquBookAmount()
    {
        ...
        int currentPossibilityProtoC =
            Get_Acquisitable_ProtoC(SaveDataManager.instance.GetItemAmount(1));
    ...
    protected override void Set_AcquBookAmount(int amount)
    {
        ...
        bool canCvtByProtoC = needProtoC <= (SaveDataManager.instance.GetItemAmount(1));
    ...
    private void Set_AcquAmount_Core()
    {
        protoCvtMaterialEui.Set_PossessionAmountTxt(
            SaveDataManager.instance.GetItemAmount(1).ToString());
    }
    ...
    protected override void Convert()
    {
        ...
        SaveDataManager.instance.UseHighLvItem(1, acquisitionBookAmount * need_ProtoC);
