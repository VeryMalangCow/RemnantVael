...
public class EnemyPattern_Melee : EnemyPattern
{
    ...
    protected override IEnumerator Play_ThisPattern_Cor()
    {
        ...
        SoundManager.instance.Play_2D_SFX_EnemyAttack_Random(enemy.Get_AS(), "Sword", 2);
    ...
    private State_TF2D State_StartTF(Vector2 spawnPos, Vector2 targetDir)
    {
    ...
    private AttackerState_EndTF State_EndTF(Vector2 spawnPos, Vector2 targetDir)
    {
