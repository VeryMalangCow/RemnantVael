...
public class CvtAcquisitionEUIController : ElementUIController
{
    ...
    {
        AfterIconImg.sprite = UnitManager.Instance.CvtMaterialConditionIcon.Get_Special(true);
        Play_AfterImg();
    ...
    {
        AfterIconImg.sprite = UnitManager.Instance.CvtMaterialConditionIcon.Get_Special(false);
        Play_AfterImg();
    }
