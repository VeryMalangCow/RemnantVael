...
public class MissileSkillController : ActiveSkillController
{
    ...
    private void Play_ShotEachMissile()
    {
        ...
        if (missile != null)
        {
            ...
            // Sound
            SoundManager.instance.PlayPlayerRandomThemeSfx(transform.position, "MissileShot");
        }
    ...
    private BulletState Get_CurrentBulletState()
    {
        return new BulletState(
            new CombatState(
                ...
                new DmgState(DamageType.Physics, playerController.baseWeapon.baseDamage.buffedState * power.actualState * 1.5f),
